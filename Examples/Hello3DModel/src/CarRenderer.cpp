...
void CarRenderer::onAttach() {
    Nest::ProgramAsset programAsset =
        Nest::AssetLoader::loadProgram("Shaders/Model3d_vertex.glsl", "Shaders/Model3d_fragment.glsl");
    m_model3D.create(createProgram(programAsset.getBirdProgramCreate()), "Models/cube.obj", "model3D");
}
