...
void main() {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        color.rgb = mix(color.rgb, blobColor.rgb, blobColor.a);
        color.a = max(blobColor.a, color.a);
    }

    outColor = color;
//    outColor = vColorBackground;
}